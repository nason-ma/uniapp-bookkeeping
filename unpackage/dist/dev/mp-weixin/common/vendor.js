...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"ColorUi for UniApp","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var install = function install(Vue, vm) {
  ...
  Vue.prototype.$u.http.interceptor.response = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var refreshResult;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
              res.statusCode == 200 || res.statusCode == 201)) {_context.next = 4;break;}return _context.abrupt("return",



              res.data);case 4:if (!(
              res.statusCode == 401)) {_context.next = 11;break;}_context.next = 7;return (

                RefreshToken(res, vm));case 7:refreshResult = _context.sent;return _context.abrupt("return",
              refreshResult.data);case 11:return _context.abrupt("return",



              false);case 12:case "end":return _context.stop();}}}, _callee);}));return function (_x) {return _ref.apply(this, arguments);};}();
...
RefreshToken(_x2, _x3) {return _RefreshToken.apply(this, arguments);}function _RefreshToken() {_RefreshToken = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(response, vm) {var Authorization, refreshResult, resultData, wxLoginRes, loginResult, _resultData, result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            ...
            uni.redirectTo({
              url: "/pages/index/index" });case 30:case "end":return _context2.stop();}}}, _callee2);}));return _RefreshToken.apply(this, arguments);}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _user = _interopRequireDefault(__webpack_require__(/*! ../api/user.js */ 44));
...
var _bill = _interopRequireDefault(__webpack_require__(/*! ../api/bill.js */ 48));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var install = function install(Vue, vm) {
  ...
  var isScopeUserInfo = function isScopeUserInfo() {
    uni.getSetting({
